...
class smartclone
{
    ...
    public function execute()
    {
        ...
        if ($pluginsHandler->getPlugin($this->_fromModule) && $pluginsHandler->pluginPatterns) {
            foreach ($pluginsHandler->pluginPatterns as $aPattern) {
    ...
    public function cloneFileFolder($path)
    {
    ...
    public function getConstantPattern($aPattern = false)
    {
    ...
    public function prefixSuffix($text, $aPattern)
    {
    ...
    public function storeLogsToFile()
    {
